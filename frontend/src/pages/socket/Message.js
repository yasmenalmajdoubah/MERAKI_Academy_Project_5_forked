            ...
            <div className="p-4 bg-gray-200">
                <div className="flex">
                    <input type="text" placeholder="write here ...."
                        className="flex-1 appearance-none border border-gray-300 rounded-md py-2 px-4 bg-white text-gray-700 placeholder-gray-400 focus:outline-none focus:border-blue-500" onChange={(e)=>{
                          setTo(e.target.value)
                      }}/>
                    <button className="ml-2 px-4 py-2 bg-blue-500 text-white font-semibold rounded-md" onClick={()=>{
sendMessage()
    }} >SEND</button>
                </div>
            </div>
