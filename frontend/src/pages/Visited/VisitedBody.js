...
export const VisitedBody = () => {
  ...
  const { userInfo, userId, experience, token, institution, visitUserInfo } =
    useSelector((state) => {
      return {
      ...
      {visitUserInfo.role_id === 2 ? (
        <div>
          <div className="p-6 ml-3 w-full mb-8 mt-3 mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
            <div>
              <div className="text-xl font-medium text-black" id="About">
                About
              </div >
        ...
        <div className="">
          <div className="p-6 ml-3 w-full mb-8 mt-3 mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
            <div>
              ...
              <p className="text-slate-500">{visitUserInfo.education}</p>
            </div>
          </div>
          <div className="p-6 ml-3 w-full mb-8 mt-8 mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
            <div>
              ...
              <p className="text-slate-500">{visitUserInfo.skills}</p>
            </div>
          </div>
          <div className="p-6 ml-3 w-full mb-8 mt-8 mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
            <div>
