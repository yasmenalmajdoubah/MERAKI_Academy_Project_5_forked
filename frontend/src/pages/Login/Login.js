        ...
        <div className="flex-none">
          ...
          <div>
            <form onSubmit={login}>
              ...
              <input
                className="mb-2 w-60 h-10 border-2 border-slate-500 rounded-md pl-2.5"
                type="email"
                placeholder="Email"
              ...
              <button
                className=" mt-3 bg-black text-white w-60 h-10 border-2 rounded-md shadow-lg"
                onClick={(e) => {
                  login(e);
                }}
              >
          ...
          <div className="flex-col mt-3">
            ...
            <button
              className="bg-blue-950 text-white w-60 h-10 border-2 rounded-md shadow-lg"
              onClick={() => {
                navigate("/register");
              }}
            >
...
<p>
        ...
        <div className="flex-none ">
          ...
          <div className="">
            <img height={350} width={350} src="https://cdni.iconscout.com/illustration/premium/thumb/woman-searching-for-job-4584379-3962168.png" />
          </div>
        </div>
      </div>
    </>
